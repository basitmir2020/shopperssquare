    ...
    public partial class all : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderEnquiry", x => x.EnquiryId);
                    table.ForeignKey(
                        name: "FK_OrderEnquiry_Order_OrderId",
                        column: x => x.OrderId,
                        principalSchema: "Identity",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrginalPrice = table.Column<float>(type: "real", nullable: false),
